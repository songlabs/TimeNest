...
/// Since TimeNest is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "TimeNest_TimeNest"
        ...
        fatalError("unable to find bundle named TimeNest_TimeNest")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class TimeNestResources: NSObject {
