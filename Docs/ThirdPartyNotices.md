...
This inventory is based on both checked-in `Package.resolved` files as of 2026-06-20. They resolve the same two Google Swift Package Manager wrapper repositories. Recheck this document whenever package versions change.
