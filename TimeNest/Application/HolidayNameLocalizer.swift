...
struct HolidayNameLocalizer {
    ...
    private func buildKoreaMappings() -> [String: String] {
        ...
        let mappings: [(String, String)] = [
            ...
            ("buddhas birthday (in lieu)", "부처님 오신 날 대체공휴일"),
            // 其他韩国节假日
            ("new years day", "신정"),
            ("lunar new year", "설날"),
            ("korean new year", "설날"),
            ...
            ("march 1st movement (in lieu)", "3·1절 대체공휴일"),
            ("constitution day", "제헌절"),
            ("victory day", "광복절"),
            ("liberation day", "광복절"),
            ("liberation day (in lieu)", "광복절 대체공휴일"),
            ("memorial day", "현충일"),
            ("national foundation day", "개천절"),
            ("national foundation day (in lieu)", "개천절 대체공휴일"),
            ("hangul day", "한글날"),
            ("hangeul day", "한글날"),
            ("chuseok", "추석"),
    ...
    private func buildUSAMappings() -> [String: String] {
        ...
        let mappings: [(String, String)] = [
            ...
            ("independence day (in lieu)", "Independence Day (Observed)"),
            ("labor day", "Labor Day"),
            ...
            ("juneteenth (in lieu)", "Juneteenth (Observed)"),
            ("juneteenth (in lieu) (regional holiday)", "Juneteenth (Observed)"),
